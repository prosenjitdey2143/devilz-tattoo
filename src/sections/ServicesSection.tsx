        ...
        <div className="flex flex-col border-t border-[#050505]/10">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group relative border-b border-[#050505]/10 py-12 md:py-16 flex items-center justify-between cursor-pointer"
            >
              <div className="flex items-center gap-8 md:gap-16 relative z-10">
                ...
                <h3 className="text-4xl md:text-7xl font-bebas text-[#050505] transition-transform duration-500 group-hover:translate-x-4">
                  {service.title}
                </h3>
              </div>

              <div className="hidden md:block max-w-xs relative z-10 opacity-40 group-hover:opacity-100 transition-opacity">
                <p className="text-[#050505] text-sm tracking-wide">{service.desc}</p>
              </div>
